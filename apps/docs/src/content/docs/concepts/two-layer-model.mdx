...
description: Understand the difference between Domain (a durable flow across time) and Pipeline (run-once finite workflow) and know when to reach for each.
---
...
| Does it have phases an entity moves through over time? | Yes | No |
