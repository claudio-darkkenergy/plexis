---
title: Key Types
description: Reference for DomainFollowResult, PipelineRunResult, DomainSnapshot, DomainHistoryEntry, NodeInspection, GraphDescriptor, PatchLike, ErrorPolicy, TraceEvent, TraceLevel, and TraceStatus. Updated for 2.0.0 — DomainSnapshot uses phase, TraceLevel uses phase.
---
